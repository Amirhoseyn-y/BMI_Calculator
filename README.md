...
.
![empty bmi](Screenshots/bmi_empty.png)
...
.
![filled bmi](Screenshots/bmi_result.png)


پس از زدن دکمه Calculate , BMI و وضعیت آن با توجه به جنسیت چاپ میشود

.
![error](Screenshots/gender_error.png)


جنسیت بایستی وارد شود, در غیر اینصورت پیام مناسب نمایش داده میشود
.
